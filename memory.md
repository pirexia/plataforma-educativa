...
**Rama activa**: `develop`, limpia y sincronizada con `origin` tras el merge de `1.4c` (commit `69fa58a`). Rama `feature/REQ-AUTH-004-sso-saml` borrada local y remota. Sin rama de trabajo abierta — toca crear una nueva para `1.5`.

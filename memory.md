...
**Rama activa**: `feature/REQ-AUTH-004-sso-saml`, PR [#160](https://github.com/pirexia/plataforma-educativa/pull/160) esperando CI para mezclar a `develop`. Tras el merge, borrar la rama local y remota y crear una nueva para `1.5`.

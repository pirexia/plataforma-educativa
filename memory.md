...
**Rama activa**: `develop`, limpia y sincronizada con `origin` tras el merge del `chore/` de alcance de subagentes. Ramas `feature/REQ-AUTH-004-sso-saml` y `chore/alcance-declarado-subagentes` borradas local y remota. Sin rama de trabajo abierta — toca crear una nueva para `1.5`.

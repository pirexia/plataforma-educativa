...
- [ ] **1.6c · `REQ-BO`: matriz de módulos** [SONNET]
  ...
  Especificación aprobada 2026-09-15 (`docs/modulos/REQ-BO/funcional.md §15.3`): `RN-BO-63` a `82`, `CA-BO-128` a `148`, tres preguntas abiertas resueltas (`OPEN-BO-17` a `19`). Verificado que ninguno de los criterios previos de `ADR-045`/`§13.3` estaba ya satisfecho en código. Implementado 2026-09-15/16 (rama `feature/REQ-BO-002-matriz-modulos-spec`), dos hallazgos propios Alta corregidos (issues #215/#216) más varios de la revisión independiente en curso. Pendiente: cerrar los hallazgos Alta de `db-reviewer`/`doc-reviewer` y mezclar.

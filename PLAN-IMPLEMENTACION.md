...
- [ ] **1.3b · `REQ-AUTH-003`: MFA — correo como segundo factor y excepciones temporales** [SONNET]
  ...
  **En curso 2026-08-27** — piezas 1, 2 y 4 de 4 completas y commiteadas (backend); pieza 3 (pantalla `/administracion/mfa`) pendiente. Ver detalle y siguiente paso concreto en `memory.md`.

...
- [ ] **1.2b · `REQ-AUTH-005`: panel de sesiones activas, cierre remoto y detección de dispositivo** [SONNET] — **EN CURSO**
  ...
  **Especificación escrita** 2026-08-25 (`docs/modulos/REQ-AUTH/*.md`, Parte B), rama `feature/REQ-AUTH-005-1.2b-sesiones-activas` (commit `367e51d`). **Pendiente de aprobación del usuario** antes de implementar: 5 preguntas abiertas `OPEN-AUTH-13` a `OPEN-AUTH-17` en `funcional.md §B.13`. Detalle en `memory.md`.

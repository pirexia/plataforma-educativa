...
/**
 * `ADR-042 §4.4`, ampliado en `funcional.md §F.3.2`/`§F.4.4` (1.4b). El
 * controlador del *callback* tiene que hacer algo distinto con cada uno
 * — salvo `IdTokenInvalid`, que `funcional.md §F.7.1` agrupa a propósito
 * con `ProviderUnreachable` bajo el mismo código de salida
 ...
 * cuál de los cinco puntos falló va al registro de aplicación
 * (`operacion.md §F.8`), no a la pantalla.
 */

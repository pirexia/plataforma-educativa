...
- **Proceso**: un subagente `implementer` relanzado tras un corte de cuota recortó `GET /mfa-compliance/users` del alcance ya aprobado, sin autorización — corregido, y motivó una norma nueva en `CLAUDE.md §3` (v2.1.3): relanzar un subagente de ejecución no es licencia para decidir alcance.
